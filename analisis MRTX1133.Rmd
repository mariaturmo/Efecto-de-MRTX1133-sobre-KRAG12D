...
colnames(expdata)=c("1222Control 1", "1222Control 2", "1222Control 3", 
                    "1222TMRX 1","1222TMRX 2","1222TMRX 3", 
                    "3226Control 1", "3226Control 2", "3226Control 3", 
                    "3226TMRX 1","3226TMRX 2","3226TMRX 3" )
...
```{r}
#Recuento de lecturas ppor millón
library(edgeR)
...
library(limma)
grupos= c("Control1222", "Control1222", "Control1222", "TMRX1222",
          "TMRX1222","TMRX1222", "Control3226", "Control3226", 
          "Control3226", "TMRX3226","TMRX3226","TMRX3226")

diseño= model.matrix(~0+grupos)

colnames(diseño)= gsub("grupos", "", colnames(diseño))
rownames(diseño) = c("Control1222", "Control1222", "Control1222", "TMRX1222","TMRX1222","TMRX1222", "Control3226", "Control3226", "Control3226", "TMRX3226","TMRX3226","TMRX3226")
...
cont.matrix = makeContrasts(efecto1222 = (Control1222 - TMRX1222), 
                            efecto3226 =(Control3226 - TMRX3226), 
                            levels = diseño)
cont.matrix
```
...
vennDiagram(vc, include=c("up", "down"),counts.col=c("red", "blue"),
...
ego_up_1222 = enrichGO(gene = entrez_up_1222,
                ...
                readable = TRUE)
head(ego_up_1222)
dotplot(ego_up_1222, showCategory=10)
goplot(ego_up_1222, showCategory = 2)
cnetplot(ego_up_1222)
library(enrichplot)
ego_sim_up_1222= pairwise_termsim(ego_up_1222)
emapplot(ego_sim_up_1222, cex_label_category=0.5)
```
...
ego_down_1222 = enrichGO(gene = entrez_down_1222,
                ...
                readable = TRUE)
head(ego_down_1222)
dotplot(ego_down_1222, showCategory=10)
goplot(ego_down_1222, showCategory = 2)
cnetplot(ego_down_1222)
library(enrichplot)
ego_sim_down_1222= pairwise_termsim(ego_down_1222)
emapplot(ego_sim_down_1222, cex_label_category=0.5)
```
...
ego_up_3226 = enrichGO(gene = entrez_up_3226,
                ...
                readable = TRUE)
head(ego_up_3226)
dotplot(ego_up_3226, showCategory=10)
goplot(ego_up_3226, showCategory = 2)
cnetplot(ego_up_3226)
library(enrichplot)
ego_sim_up_3226= pairwise_termsim(ego_up_3226)
emapplot(ego_sim_up_3226, cex_label_category=0.5)
```
...
ego_down_3226 = enrichGO(gene = entrez_down_3226,
                ...
                readable = TRUE)
head(ego_down_3226)
dotplot(ego_down_3226, showCategory=10)
goplot(ego_down_3226, showCategory = 2)
cnetplot(ego_down_3226)
library(enrichplot)
ego_sim_down_3226= pairwise_termsim(ego_down_3226)
emapplot(ego_sim_down_3226, cex_label_category=0.5)
```
